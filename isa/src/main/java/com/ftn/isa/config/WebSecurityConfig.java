...
// import com.ftn.isa.auth.RestAuthenticationEntryPoint;

// import static org.springframework.security.config.Customizer.withDefaults;
// import com.ftn.isa.service.CustomUserDetailsService;
...
// // 2. kroz koji enkoder da provuce lozinku koju je dobio od klijenta u
// zahtevu
...
// // Handler za vracanje 401 kada klijent sa neodogovarajucim korisnickim
// imenom i
...
// REST
// // aplikacija
// // ovo znaci da server ne pamti nikakvo stanje, tokeni se ne cuvaju na
// serveru
...
// requests.antMatchers("/api/v1/auth/**").permitAll() // /auth/**
// .antMatchers("/h2-console/**").permitAll() // /h2-console/** ako se koristi
// H2 baza)
// // .antMatchers("/users/**").hasRole("RegisteredUser") // /api/foo
...
// // koji tip korisnika moze da pristupi odgovarajucoj ruti. Npr. ukoliko
// zelimo
...
// // SecurityContext-u
// // Dozvoljena POST metoda na ruti /auth/login, za svaki drugi tip HTTP metode
