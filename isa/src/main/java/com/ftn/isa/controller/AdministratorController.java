...
public class AdministratorController {
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "successful operation", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = Administrator.class))))
	})
	...
	public ResponseEntity<Administrator> getAdminByUsername(
			@Parameter(name = "username", description = "Username of user", required = true) @PathVariable("username") String username) {
		Administrator administrator = administratorService.findOneByUsername(username).orElse(null);
	...
	/*
	 * @Operation(summary = "Create new Centers", description =
	 * "Create new Centers", method = "POST")
	 * 
	 * @ApiResponses(value = {
	 * 
	 * @ApiResponse(responseCode = "201", description = "Created",
	 * content = { @Content(mediaType = "application/json", schema
	 * = @Schema(implementation = Administrator.class)) }),
	 * 
	 * @ApiResponse(responseCode = "409", description =
	 * "Not possible to create new Center when given id is not null",
	 * content = @Content)
	 * })
	 * 
